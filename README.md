...
What is this?
-------------
A data aggregation/analytics API to extract store data (number of downloads, purchases, ratings, ...) from the BlackBerry AppWorld developer backend (the so called "Vendor Portal"). This does not include any visualization.
...
1) Installationing the Standard Edition
----------------------------------
